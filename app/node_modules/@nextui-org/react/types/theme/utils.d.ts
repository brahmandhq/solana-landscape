import { ThemeType, TokenValue, TokenKeyName } from '@nextui-org/react/types/theme/types';
export declare const getTokenValue: (token: TokenKeyName, tokenName: string) => string;
