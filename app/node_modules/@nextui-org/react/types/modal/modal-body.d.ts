...
import { ModalBodyVariantsProps } from '@nextui-org/react/types/modal/modal.styles';
interface Props {
    className?: string;
    autoMargin?: boolean;
...
export declare type ModalBodyProps = Props & typeof defaultProps & NativeAttrs & ModalBodyVariantsProps & {
    css?: CSS;
};
